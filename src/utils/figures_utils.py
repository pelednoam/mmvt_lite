...
def plot_color_bar(data_max, data_min, colors_map, ax=None, fol='', do_save=True, cb_ticks=None,
    ...
    print(data_max, data_min, colors_map, fol, cb_ticks, background_color, cb_ticks_font_size,
          colorbar_name, set_cb_max_min_using_ticks, cb_ticks_perc)
    ...
    if do_save:
        ...
        print('Saving colorbar in {}'.format(fname))
...
def find_color_map(color_map):
    ...
    if color_map_name not in plt.cm.cmap_d:
        ...
        return plt.cm.cmap_d[color_map_name]
...
def combine_two_images(figure1_fname, figure2_fname, new_image_fname, comb_dim=PICS_COMB_HORZ, dpi=100,
    ...
    if comb_dim == PICS_COMB_VERT:
        crop_image(figure1_fname, figure1_fname, dx=0, dy=100, dw=0, dh=250)
        crop_image(figure2_fname, figure2_fname, dx=0, dy=100, dw=0, dh=150)
...
if __name__ is '__main__':
    # plot_color_bar(3.5, 2.0, 'YlOrRd', cb_ticks=[2.0, 3.5], background_color='black',
    #                cb_ticks_font_size=16, colorbar_name='YlOrRd_colorbar.jpg',
    #                set_cb_max_min_using_ticks=True, cb_ticks_perc=2)
    ...
    parser.add_argument('--figure1_fname', required=False, default='')
    parser.add_argument('--figure2_fname', required=False, default='')
    parser.add_argument('--new_image_fname', required=False, default='')
    parser.add_argument('--comb_dim', required=False, default=0, type=int)
