...
def register_ct_to_mr(
        subject, subjects_dir, ct_fname, reg_method='bbregister', output_fname='', lta_name='', overwrite=False, cost_function='nmi',
        print_only=False):
    '''
    ...
    reg_method: Str
        supported values: 'bbregister', 'robust_register'
    overwrite : Bool
    ...
    fu.robust_register(
        subject, subjects_dir, ct_fname, rawavg, output_fname, lta_name, reg_method, cost_function, print_only)
    if print_only:
        return True
    else:
